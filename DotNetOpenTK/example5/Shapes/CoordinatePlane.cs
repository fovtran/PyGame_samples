...
{
    public sealed class CoordinatePlane: DrawableShape
    {
        ...
        public CoordinatePlane( double Width, double Height, double Length, SubDivs subdivs, double radius, bool useDL ) : base( useDL )
        {
